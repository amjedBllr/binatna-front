...
const About = () => {
  return (
    <div id="about" className="container mx-auto py-20 h-screen">
      <div className="services flex flex-col items-start p-5">
        <h3 className='font-bold text-secondary text-2xl p-5 pl-24'>Our Services</h3>
        <br />
      ...
      <div className="founder flex flex-col items-star p-5">
        <h3 className='font-bold text-secondary text-2xl p-5 pl-24'>Our Founder</h3>
        <br />
        <div className='w-full px-10'>
          <div class="founder-card">
            ...
            <img src={founder} className="absolute right-28 top-5 h-60" />
          </div>
        </div>
      </div>
    </div>
